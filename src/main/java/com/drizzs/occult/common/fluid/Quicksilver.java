...
public class Quicksilver {
    ...
    public static final ResourceLocation MERCURY_STILL_TEXTURE = new ResourceLocation(MODID,"/block/fluids/quicksilver_still");
    public static final ResourceLocation MERCURY_FLOWING_TEXTURE = new ResourceLocation(MODID,"/block/fluids/quicksilver_flowing");
