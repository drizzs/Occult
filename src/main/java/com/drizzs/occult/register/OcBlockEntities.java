...
public class OcBlockEntities {
   ...
   // public static final RegistryObject<BlockEntityType<?>> PRESSURE_COLLECTOR4_BE = BLOCK_ENTITY_TYPE.register("pressure_collector4",
    ...
    public static final RegistryObject<BlockEntityType<CrucibleBE>> CRUCIBLE_BE = BLOCK_ENTITY_TYPE.register("crucible",
      () -> BlockEntityType.Builder.of(CrucibleBE::new, CRUCIBLE.get()).build(null));
